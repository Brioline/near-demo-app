...
export const lightClientProof = async (
  wrapper_lightClientProofRequest: LightClientProof
) => {
...
export const accessKeyChanges = async (
...
export const accountChanges = async (
  accountIdArray: [nearApi.Account.accountId],
  blockQuery: nearApi.Account
) => {
...
export const contractCodeChanges = async (
  accountIdArray: [nearApi.Account.accountId],
  blockQuery: nearApi.Account
) => {
...
export const contractStateChanges = async (
  accountIdArray: [nearApi.Account.accountId],
  blockQuery: nearApi.Account,
  keyPrefix: string
) => {
...
export const singleAccessKeyChanges = async (
  blockQuery: nearApi.Account,
  networkId: string
) => {
  const accessKeyArray = [
    {
      ...
      public_key: (
        await nearApi.Near.connection.signer.getPublicKey(
          nearApi.Account.accountId,
          networkId
        )
      ).toString(),
    },
...
export const txStatus = async (
  accountId: nearApi.Account,
  txHash: nearApi.providers.FinalExecutionOutcome
) => {
